...
appsignup.addEventListener("submit",
function fetchlogin(event){
    event.preventDefault()
    let firstname = applogin["firstname"].value;
    let lastname = applogin["lastname"].value;
    let username = applogin["username"].value;
    let email = applogin["email"].value;
    let password = applogin["password"].value;
    let role = applogin["role"].value;
    if (username == ""){
